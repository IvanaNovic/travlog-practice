    ...
    <div>
      ...
      <div className="relative flex flex-row gap-4 justify-center p-6 xsm:p-10 md:p-20 md:px-40">
        <div className="flex flex-col gap-4">
          <div className="relative ">
            ...
            <div className="absolute -left-4 -bottom-4">
              <button className="rounded-full bg-secondary py-2 px-2 shadow-[rgba(0,0,15,0.09)_4px_15px_10px_1px]">
        ...
        <div className="flex relative">
          ...
          <div className="absolute left-4 -bottom-4 md:left-12  ">
            <button className="rounded-full bg-orange py-2 px-2 shadow-[rgba(0,0,15,0.09)_4px_15px_10px_1px]">
          ...
          <div className="absolute -right-12 bottom-12 md:bottom-36 md:-right-16 md:w-40 md:h-8">
            <button className="inline-flex gap-1 rounded-full bg-fullwhite py-2 px-2 md:px-4 shadow-[rgba(0,0,15,0.09)_4px_15px_10px_1px] text-xs md:text-lg   ">
